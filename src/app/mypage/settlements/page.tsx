                ...
                <div className="space-y-3">
                    ...
                    <div className="card p-4 bg-gray-900/80 border border-gray-800 rounded-xl mb-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            {/* 상태 필터 */}
                            <div>
                                <label className="block text-xs text-gray-500 mb-1">정산 상태</label>
                                <select
                                    value={filterStatus}
                    ...
                    {loading ? (
                        ...
                        settlements.map((s) => {
                            ...
                            return (
                                <div key={s.id} className="card p-4 bg-gray-900 border border-gray-800 rounded-xl">
                                    <div className="flex justify-between items-start mb-2">
                                        <div className="flex-1 min-w-0">
                                            <p className="font-medium truncate">{s.productName || '상품명 없음'}</p>
                                            <p className="text-xs text-gray-500 mt-0.5">{formatDate(s.createdAt)}</p>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-3 gap-2 mt-3 pt-3 border-t border-gray-800">
                                        <div>
                                            ...
                                            <p className="text-sm font-semibold text-white">₩{formatPrice(s.salesAmount ?? 0)}</p>
                                        </div>
                                        <div>
